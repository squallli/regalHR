var AngularApp = angular.module('RG01', []);
...
AngularApp.controller('Ctrl', function ($scope) {
    ...
    $scope.GetEmpList = function () {
        ...
        $.ajax({
            ...
            url: "../Emp/GetEmpList",
            dataType: 'Json',
            data: 'FulltimeFlag=&company=' + $scope.ReportForm.Company + "&DepartMentNo=" + $scope.ReportForm.DepartMentNo + "&status=1&Sex=",
            async: false,
    ...
    $scope.ExportExcel = function () {
        ...
        $.ajax({
            type: "POST",
            url: "../ReportOutgoing/GetRG01ToExcel",
