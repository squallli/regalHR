...
AngularApp.controller('Ctrl', function ($scope) {
    ...
    $scope.update("../Program/GridViewer", UserFreeStyle.PageNum);
    ...
    $scope.Orderby = function (id,OrderField) {
        ...
        $.ajax({
            type: "POST",
            url: "../Program/SaveUserFreeStyle",
            dataType: 'Json',
            data: 'UserFreeStyle=' + angular.toJson($scope.UserFreeStyle),
            async: false,
            success: function (data) {

                $scope.update("../Program/GridViewer", 0);
    ...
    $scope.DelBtn = function () {
        ...
        $.ajax({
            type: "POST",
            url: "../Program/ProgramFormDel",
            dataType: 'Json',
            data: 'ProgID=' + $scope.DeleteRecordID,
            async: false,
            success: function (data) {
    ...
    $scope.Link = function (RecordID) {
        ...
        $.ajax({
            ...
            async: false,
            success: function (data) {
                document.location.href = "../Program/ProgramForm";
            },
            error: function () {
                alert("Error !");
            }
