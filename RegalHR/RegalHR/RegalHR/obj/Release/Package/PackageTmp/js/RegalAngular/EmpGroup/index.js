...
AngularApp.controller('Ctrl', function ($scope) {
    ...
    $scope.update("../EmpGroup/GridViewer", UserFreeStyle.PageNum);
    $scope.GetEmpList();
    ...
    $scope.Orderby = function (id, OrderField) {
        ...
        $.ajax({
            type: "POST",
            url: "../EmpGroup/SaveUserFreeStyle",
            dataType: 'Json',
            data: 'UserFreeStyle=' + angular.toJson($scope.UserFreeStyle),
            async: false,
            success: function (data) {

                $scope.update("../EmpGroup/GridViewer", 0);
    ...
    $scope.Link = function (RecordID) {
        ...
        $.ajax({
            ...
            async: false,
            success: function (data) {
                document.location.href = "../EmpGroup/EmpGroupForm";
            },
            error: function () {
                alert("Error !");
            }
